...
from utils.utils import shuffle_two_list, load_input_HIV, convert_to_graph, split_train_eval_test
...
if __name__ == '__main__':
    ...
    flags.DEFINE_integer('max_to_keep', None, '`max_to_keep` for `tf.train.Saver`')
